export default function Education() {
  return (
    <section id="education" className="max-w-3xl mx-auto px-6 py-20 border-t border-zinc-100">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <h3 className="text-base font-semibold text-zinc-900">University of Waterloo</h3>
          <p className="text-sm text-zinc-600 mt-1">Bachelor of Computer Engineering</p>
